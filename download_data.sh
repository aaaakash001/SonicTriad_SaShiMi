...
wget https://huggingface.co/necrashter/SaShiMi-796/resolve/main/youtube-mix-models.zip 
unzip -o youtube-mix-models.zip

echo Downloading and unzipping the MNIST models...
wget https://huggingface.co/necrashter/SaShiMi-796/resolve/main/mnist-models.zip 
unzip -o mnist-models.zip

echo
echo Downloading and unzipping the Youtube Mix dataset...
wget https://huggingface.co/necrashter/SaShiMi-796/resolve/main/youtube-mix.zip 
